          ...
          <div class="">
            ...
            <div class="page-title">
              ...
              <div class="title_left">
                ...
                <h3>Feedback Ekle / Düzenle <small></small></h3>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <br />
                       ...
                       <form action="{{ route('feedbacks.update',$feedback->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" value="{{ $feedback->name }}"  placeholder="Başlık">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="title" value="{{ $feedback->title }}" style="width: 25%" required placeholder="Ünvan">
                      ...
                      <textarea name="text" id="editor1">{{ $feedback->text }}</textarea>                      
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    ...
                    <h2>Feedback<small>ve</small> Detaylar</h2>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      @if($feedback->count()>0)
                        ...
                        <tr>feedback
                          ...
                          <td> <form action="{{ route('feedbacks.destroy',$feedback->id) }}" method="post"> <a href="{{ route('feedbacks.edit',$feedback->id) }}" class="btn btn-success">Düzenle</a>{{ csrf_field() }} {{ method_field('DELETE') }}<button type="submit"  class="btn btn-danger">Sil</button></form></td>

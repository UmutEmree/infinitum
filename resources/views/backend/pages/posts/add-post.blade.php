 @extends('backend.main')
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Referans <small>İçerikleri </small></h2>

                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="{{ route('references.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                        {{ csrf_field() }}
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="link" value="{{ old('link') }}" placeholder="Referans Linki">
  ...
  @if(count($errors)>0)
              ...
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Referans Detayı <small>Referans detay bilgileri</small></h2>

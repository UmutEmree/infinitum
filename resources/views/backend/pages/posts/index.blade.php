                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      @if($references->count()>0)
                        ...
                        <tr>
                          ...
                          <td>@if($post->home ==1) Evet @else Hayır @endif</td>

                          <td> <form action="{{ route('references.destroy',$post->id) }}" method="post"> <a href="{{ route('references.update',$post->id) }}" class="btn btn-success">Düzenle</a>{{ csrf_field() }} {{ method_field('DELETE') }}<button type="submit"  class="btn btn-danger">Sil</button></form></td>

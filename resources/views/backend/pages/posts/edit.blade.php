              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="{{ route('references.update',$reference->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" value="{{ $reference->name }}"  placeholder="Başlık">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="slug" value="{{ $reference->slug }}" required placeholder="Slug">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          @foreach($categories as $category)
                            ...
                            <option value="{{ $category->slug }}"{{ $reference->category_id == $category->slug ? 'selected="selected"' : '' }}>{{ $category->name }}</option>
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="link" value="{{ $reference->link }}" placeholder="Affiliate Linki">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="">
                            ...
                            <label>
                              ...
                              <input type="checkbox" class="js-switch" name="home" value="1"  @if($reference->home == '1') checked @endif  />Anasayfada Göster
                            </label>
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <img src="{{ url('uploads/references/'.$reference->image) }}" style="width: 30%">
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    ...
                    <h2>Referans <small>detay bilgileri</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <br />
                        ...
                        <input type="file" class="form-control has-feedback-left" id="inputSuccess2" name="image3">
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <img src="{{ url('uploads/references/'.$reference->image3) }}" style="width: 30%">
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="file" class="form-control has-feedback-left" id="inputSuccess2" name="image2">
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <img src="{{ url('uploads/references/'.$reference->image2) }}" style="width: 30%">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ $reference->title }}" name="title" required placeholder="Meta Title">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2"  name="meta" value="{{ $reference->meta }}" placeholder="Meta Description">
                        ...
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                         ...
                         <textarea name="text" id="editor1">{{ $reference->text }}</textarea>

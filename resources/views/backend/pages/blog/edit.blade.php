          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Blog Ekle / Düzenle <small></small></h3>
              </div>
            ...
            <div class="row">
             ...
             <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                       <form action="{{ route('blog.update',$blog->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                              {{ csrf_field() }}
                        {{ method_field('PUT') }}
                     
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" value="{{ $blog->name }}"  placeholder="Başlık">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="slug" value="{{ $blog->slug }}" style="width: 25%" required placeholder="Slug">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <img src="{{ url('uploads/blogs/'.$blog->image) }}" style="width: 30%">
                      </div>

                      <textarea name="text" id="editor1">{{ $blog->text }}</textarea>                      
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Blog<small>ve</small> Detaylar</h2>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      @if($blog->count()>0)
                        ...
                        <tr>blog
                          <td>{{ $blog->name }}</td>
                          <td>{{ $blog->slug }}</td>
                          <td> <form action="{{ route('blog.destroy',$blog->id) }}" method="post"> <a href="{{ route('blog.edit',$blog->id) }}" class="btn btn-success">Düzenle</a>{{ csrf_field() }} {{ method_field('DELETE') }}<button type="submit"  class="btn btn-danger">Sil</button></form></td>

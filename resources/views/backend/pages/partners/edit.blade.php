              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="{{ route('partners.update',$partner->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" value="{{ $partner->name }}"  placeholder="Başlık">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          @foreach($partners as $partner)
                            ...
                            <option value="{{ $partner->id }}"{{ $partner->partner_id == $partner->id ? 'selected="selected"' : '' }}>{{ $partner->name }}</option>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="">
                            ...
                            <label>
                              ...
                              <input type="checkbox" class="js-switch" name="home" value="1"  @if($partner->home == '1') checked @endif  />Anasayfada Göster
                            </label>
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <img src="{{ url('uploads/partners/'.$partner->image) }}" style="width: 30%">

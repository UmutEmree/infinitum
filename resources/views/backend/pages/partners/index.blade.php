                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      @if($partners->count()>0)
                        ...
                        <tr>
                          <td>{{ $partner->name }}</td>                      
                          <td><img style="width: 10%" src="{{ url('uploads/partners/'.$partner->image) }}"></td>
                          <td> <form action="{{ route('partners.destroy',$partner->id) }}" method="post"> <a href="{{ route('partners.update',$partner->id) }}" class="btn btn-success">Düzenle</a>{{ csrf_field() }} {{ method_field('DELETE') }}<button type="submit"  class="btn btn-danger">Sil</button></form></td>
                        </tr>
                        @endforeach
                      @endif
                      </tbody>

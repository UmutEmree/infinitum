...
<html lang="en">
  <head>
    ...
    <title>Infinitum Agency | Yönetim Paneli </title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href=""><i class="fa fa-home"></i> Anasayfa</a>
                   
                  </li>

                  <li><a><i class="fa fa-edit"></i> Referanslar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('references.index') }}">Referanslar</a></li>
                      <li><a href="{{ route('references.create') }}">Referans Ekle</a></li>
                  ...
                  <li><a><i class="fa fa-edit"></i>Partnerler <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('partners.index') }}">Partnerler</a></li>
                      <li><a href="{{ route('partners.create') }}">Partner Ekle</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a href=""><i class="fa fa-desktop"></i> Slider</a></li>
